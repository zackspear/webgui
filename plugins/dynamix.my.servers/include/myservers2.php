        ...
        'stateData' => [
          ...
          'ENOKEYFILE2' => [
            ...
            'error' => [
              ...
              'message' => _('It appears that your license key file is corrupted or missing').". "._('The key file should be located in the /boot/config directory on your USB Flash boot device').'. '._('If you do not have a backup copy of your license key file you may attempt to recover your key').'. '._('If this was a Trial installation, you may purchase a license key').'.',
            ],
          ],
          'ETRIAL' => [
